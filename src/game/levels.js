 ...
 *
 *  - 1910 is a tutorial. Two slow escorts at a time, they rarely shoot, and the
 *    Zeppelin is a soft target that brings no friends. A first-time player
 *    should reach it and beat it.
...
export const ERAS = [
  {
    ...
    enemyTurn: 0.95,
    bulletSpeed: 150,
    fireInterval: [3.4, 5.5],
    spawnInterval: [2.6, 4.2],
    maxEnemies: 2,
    squadronChance: 0,
    quota: 10,
    bossHp: 12,
  ...
  },
  {
    ...
    enemyTurn: 1.20,
    bulletSpeed: 175,
    fireInterval: [2.8, 4.6],
    spawnInterval: [2.2, 3.6],
    maxEnemies: 3,
    squadronChance: 0,
    quota: 13,
    bossHp: 18,
  ...
  },
  {
    ...
    enemyTurn: 1.45,
    bulletSpeed: 200,
    fireInterval: [2.3, 3.9],
    spawnInterval: [1.8, 3.0],
    maxEnemies: 4,
    squadronChance: 0.25,
    quota: 16,
    bossHp: 26,
  ...
  },
  {
    ...
    enemyTurn: 1.75,
    bulletSpeed: 220,
    fireInterval: [1.9, 3.3],
    spawnInterval: [1.5, 2.6],
    maxEnemies: 5,
    squadronChance: 0.30,
    quota: 19,
    bossHp: 34,
  ...
  },
  {
    ...
    enemyTurn: 2.05,
    bulletSpeed: 245,
    fireInterval: [1.6, 2.8],
    spawnInterval: [1.2, 2.2],
    maxEnemies: 6,
    squadronChance: 0.35,
    quota: 22,
    bossHp: 44,
