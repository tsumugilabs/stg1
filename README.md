...
| | モチーフ | 性格 |
| --- | --- | --- |
| **VIPER** | F-2 | バランス。難易度カーブの基準機で、被弾後の無敵が一番長い |
| **DRAGON** | ドラケン | 機動性。最も小回りが利き当たり判定も小さいが、射程と火力は最低。撃たずに0.4秒以上ためると旋回がさらに上がる |
| **EAGLE** | F-15 | 火力。一発が重く旗艦に2倍ダメージ、撃墜時に爆風。連射が利かず、鈍重で当たり判定も大きい。残機は4 |
| **S.WIND** | 戦闘妖精雪風 | 隠し機体。3way＋貫通、随伴ポッド、自動ロックオン照準 |
